...
#define DMA_LEN			0x24 // Not Defined Yet
#define PWM_BASE		0x40050000
#define PWM_LEN			0x28 // Not Defined Yet
#define CLK_BASE	    0x40008000
#define CLK_LEN			0xA8 // Not Defined Yet
#define GPIO_BASE		0x40014000
#define GPIO_LEN		0xB4 // Not Defined Yet

// GPIO
// -------------------------------------------------------------------------------------------------
#define SIO_BASE            0xD0000000
#define SIO_GPIO_OUT        (SIO_BASE + 0x0010)  // GPIO Output Register
#define SIO_GPIO_OUT_SET    (SIO_BASE + 0x0014)  // GPIO Set Register
#define SIO_GPIO_OUT_CLR    (SIO_BASE + 0x0018)  // GPIO Clear Register
#define SIO_GPIO_OUT_XOR    (SIO_BASE + 0x001C)  // GPIO Toggle Register
...
// Function to directly access a peripheral register
static volatile void * map_peripheral(uint32_t base, uint32_t len) {
    // Simply return a pointer to the base address of the peripheral
...
//Theatre-style crawling lightsn
